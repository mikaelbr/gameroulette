...
import com.gameroulette.client.OpponentGamer;
...
public class StartScreen extends JFrame implements ActionListener {
    ...
    private static OpponentGamer opponent;
    private static ClientGamer p1;
                    ...
                    public void actionPerformed(ActionEvent ae) {
                        Thread t = new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                opponent = new OpponentGamer(new JGPoint(700, 400), score2);
                                p1 = new ClientGamer(new JGPoint(700, 400), opponent, score, main);
