...
public abstract class JGTimer {
	...
	*/
	public JGTimer(int frames_to_alarm, boolean one_shot, JGEngineInterface engine) {
	...
	* @param one_shot  true = run only once, false = run repeatedly
	*/
	public JGTimer(int frames_to_alarm, boolean one_shot, String parent, JGEngineInterface engine) {
		set(frames_to_alarm,one_shot);
		eng = engine;
		eng.registerTimer(this);
		parent_state = parent;
