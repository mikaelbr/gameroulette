...
public class WaterWorld extends StdGame {
    ...
    public void initCanvas() {
        setCanvasSettings(40, 30, 32, 32, null, null, null);
    }
    ...
    public void paintFrame() {
        ...
        for (int i = 1; i < lives; i++) {
            drawImage(pfWidth() - 32 * i, 0, "player_l1");
        }
    }
