...
public class JGObject {
    ...
    private JGEngineInterface default_engine = null;
    ...
    public boolean setEngine(JGEngineInterface engine) {
        if (engine == null) {
            default_engine = null;
            return true;
        }
    ...
    public JGObject(String name, boolean unique_id,
            double x, double y, int collisionid, String gfxname, JGEngineInterface engine) {
        initObject(engine,
     ...
     * @param gfxname  id of animation or image, null = no image */
    public JGObject(String name, boolean unique_id,
            double x, double y, int collisionid, String gfxname, int expiry, JGEngineInterface engine) {
        initObject(engine,
                name + (unique_id ? "" + (next_id++) : ""), collisionid);
        setPos(x, y);
        setGraphic(gfxname);
    ...
    public JGObject(String name, boolean unique_id,
            ...
            int tilebbox_x, int tilebbox_y, int tilebbox_width, int tilebbox_height, JGEngineInterface engine) {
        setPos(x, y);
        initObject(engine,
                name + (unique_id ? "" + (next_id++) : ""), collisionid);
        setGraphic(gfxname);
    ...
    public JGObject(String name, boolean unique_id,
            ...
            int expiry, JGEngineInterface engine) {
        setPos(x, y);
        initObject(engine,
                name + (unique_id ? "" + (next_id++) : ""), collisionid);
        setGraphic(gfxname);
    ...
    public JGObject(String name, boolean unique_id,
            double x, double y, int collisionid, String gfxname,
            double xspeed, double yspeed, JGEngineInterface engine) {
        setPos(x, y);
        initObject(engine,
                name + (unique_id ? "" + (next_id++) : ""), collisionid);
        setGraphic(gfxname);
    ...
    public JGObject(String name, boolean unique_id,
            double x, double y, int collisionid, String gfxname,
            double xspeed, double yspeed, int expiry, JGEngineInterface engine) {
        setPos(x, y);
        initObject(engine,
                name + (unique_id ? "" + (next_id++) : ""), collisionid);
        setGraphic(gfxname);
    ...
    public JGObject(String name, boolean unique_id,
            double x, double y, int collisionid, String gfxname,
            int xdir, int ydir, double xspeed, double yspeed, int expiry, JGEngineInterface engine) {
        setPos(x, y);
        initObject(engine,
                name + (unique_id ? "" + (next_id++) : ""), collisionid);
        setGraphic(gfxname);
    ...
    public JGRectangle getBBox() {
        if (bbox != null) {
            return new JGRectangle(bbox.x + (int) x, bbox.y + (int) y,
...
//	}
    ...
    public boolean isOnPF(int marginx, int marginy) {
        ...
        if (!pfwrapx) {
            ...
            if (temp_bbox_copy.x > pfwidth + marginx) {
                return false;
            }
        }
        if (!pfwrapy) {
            ...
            if (temp_bbox_copy.y > pfheight + marginy) {
                return false;
            }
        }
        return true;
